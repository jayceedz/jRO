...
struct Battle_Config
{
	...
	//Sader's renewal mode
	int renewal_map_cache;
	int renewal_mob_db;
	int renewal_mob_skill_db;
	int renewal_mob_db_full;
	int renewal_mob_random_db;
	int renewal_mob_boss;
	int renewal_mob_branch;
	int renewal_mob_poring;
	int renewal_mob_race2_db;
	int renewal_mob_drop;
	int renewal_item_db;
	int renewal_item_combo_db;
	int renewal_item_db_full;
	int renewal_item_group_db;
	int renewal_item_bluebox;
	int renewal_item_buyingstore;
	int renewal_item_cardalbum;
	int renewal_item_delay;
	int renewal_item_flag;
	int renewal_item_giftbox;
	int renewal_item_misc;
	int renewal_item_noequip;
	int renewal_item_package;
	int renewal_item_randomopt_db;
	int renewal_item_stack;
	int renewal_item_trade;
	int renewal_item_violetbox;
	int renewal_item_randomopt_group;
	int renewal_skill_nocast_db;
	int renewal_produce_db;
	int renewal_homunculus_db;
	int renewal_exp_homun;
	//Sader's renewal mode
	int pet_catch_rate;
	int pet_rename;
