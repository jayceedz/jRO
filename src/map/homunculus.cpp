...
void read_homunculusdb(void) {
	...
	i = 1;
#else
	if (battle_config.renewal_homunculus_db)
		i = 0;
	else
		i = 1;
#endif
	...
	for(i; i<ARRAYLENGTH(filename); i++){
...
void read_homunculus_expdb(void)
{
	...
	i = 1;
#else
	if (battle_config.renewal_exp_homun)
		i = 0;
	else
		i = 1;
#endif
