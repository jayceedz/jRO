...
ACMD_FUNC(autoattack) {
	...
	if (sd->sc.option & OPTION_AUTOATTACK) {
		...
		clif_displaymessage(fd, "//========== Autoattack ==========//");
		clif_displaymessage(fd, "You can use @autoattack / @autoattack Monster ID");
		clif_displaymessage(fd, "Ex. @autoattack poring");
		clif_displaymessage(fd, "Ex. @autoattack 1002");
